...
class _Show_user_info extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Expanded(
      ...
      child: ListView(
        children: [
          _show_Text(_user_details_model.currentWeight!.toString(),"currentWeight"),
          _show_Text(_user_details_model.birthDate!,"birthDate"),
          _show_Text(_user_details_model.long!.toString(),"long"),
          _show_Text(_user_details_model.sex!,"sex"),
          _show_Text(_user_details_model.goalWeight!.toString(),"goalWeight"),
          ...
          SizedBox(height: 30,),
          _user_details_model.haveChronicDisease?Text('Chronic Disease',
            style: TextStyle(color: Color.fromARGB(255, 3, 118, 77),fontSize: 20,fontWeight: FontWeight.bold),):Container(),
          _user_details_model.haveChronicDisease?Padding(padding: EdgeInsets.all(20),
             child: Container(
               height: 100,
               child: ListView(
          ...
          TextButton(
            child: Text('Sign Out',style: TextStyle(color: Colors.grey,fontWeight: FontWeight.bold,fontSize: 25),),
              onPressed: (){
  ...
  Widget _show_Text(String title, String text){
    ...
    return ListTile(
      title:Padding(
        ...
        child: Text(text,style: TextStyle(color:Color.fromARGB(255, 3, 118, 77),fontSize: 20,fontWeight: FontWeight.bold),),
      ) ,
      subtitle:Text(title,style: TextStyle(color:Color.fromARGB(255, 3, 118, 77),fontSize: 20),) ,
    );
  }
  ...
  Widget _disease_Text(String title, String text){
    //return Text(text,style: TextStyle(color:Color(0xff005194),),);
    return ListTile(
      title:Text(text,style: TextStyle(color:Color.fromARGB(255, 3, 118, 77),fontSize: 20,fontWeight: FontWeight.bold),) ,
      trailing:Text(title,style: TextStyle(color:Color.fromARGB(255, 3, 118, 77),fontSize: 20),) ,
    );
  }
